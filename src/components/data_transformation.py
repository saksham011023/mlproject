...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        """"
        This method will return the preprocessor object and is responsible for data transformation.
        """
        try:
    ...
    def initate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info("Applying preprocessor objects on training and testing dataframe.")
